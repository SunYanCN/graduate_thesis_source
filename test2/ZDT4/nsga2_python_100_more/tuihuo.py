...
def inner(k, population, layerDict, valueDict, iDict, Tk, p_list, functionObject):
    ...
    a=np.array([1.0, 10.0, 10.0, 10.0, 10.0, 10.0, 10.0, 10.0, 10.0, 10.0])
    b=np.array([0.0, 5.0, 5.0, 5.0, 5.0, 5.0, 5.0, 5.0, 5.0, 5.0])
    ...
    individual+=(a*np.random.random(10)*yyup-b)*Tk/3000.0#

    #individual[individual>1.0]=1.0#
    #individual[individual<0.0]=0.0#
    individual=(individual<=yyup)*individual+(individual>yyup)*yyup
    individual=(individual>=yylow)*individual+(individual<yylow)*yylow
